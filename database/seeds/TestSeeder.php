...
class TestSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $tid= Test::create(['pathology_department_id'=>$pdid,'title'=>'White Blood Cells','sample_type'=>'blood','price'=>500.00])->id;
        ...
        $tid= Test::create(['pathology_department_id'=>$pdid,'title'=>'Platelets','sample_type'=>'blood','price'=>870.2])->id;
